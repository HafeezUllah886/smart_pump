                                ...
                                <table class="table table-striped table-hover">
                                    ...
                                    <tbody id="products_list">
                                        ...
                                        @endphp
                                           <tr id="row_{{ $product_id }}">
                                            ...
                                            <td class="p-0"> <span class="btn btn-sm btn-danger" onclick="deleteRow({{ $product_id }})">X</span> </td>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-end" id="totalAmount">{{number_format($purchase->total, 2)}}</th>
                                            <th></th>
                                        </tr>
                                    </tfoot>
                                </table>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="supplier_id" id="supplier_id" class="select2 w-100">
                                        @foreach ($suppliers as $supplier)
                                            <option value="{{ $supplier->id }}" {{$supplier->id == $purchase->supplier_id ? 'selected' : ''}}>{{ $supplier->title }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
