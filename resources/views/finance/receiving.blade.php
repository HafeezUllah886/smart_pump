                ...
                <div class="card-body p-0">
                    <div class="app-datatable-default overflow-auto app-scroll">
                        <table class="display app-data-table default-data-table" id="defaultDatatable">
                            ...
                            <tbody>
                                @foreach ($receivings as $key => $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('receiving.delete', $item->refID) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="myModalLabel">Create New Receiving</h5>
