                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end p-1"><span
                                                class="text-uppercase me-1 ">Opening</span></td>

                                        <td class="text-end text-dark fs-5 fw-bold p-1">{{ number_format($pre_balance, 2) }}
                                        </td>
                                    </tr>
                                    @foreach ($transactions as $item)
                                        ...
                                        <tr>
                                            ...
                                            <td class="f-w-600 text-dark p-1">{{ $item->refID }}</td>
                                    ...
                                    <tr>
                                        <td colspan="6" class="text-end p-1"><span
                                                class="text-uppercase me-1 ">Closing</span></td>

                                        <td class="text-end text-dark fs-5 fw-bold p-1">{{ number_format($balance, 2) }}
                                        </td>
                                    </tr>
                                </tbody>
